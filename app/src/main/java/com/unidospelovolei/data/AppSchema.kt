        ...
        Table(
            ...
            columns =
                listOf(
                    ...
                    Column.real("nota_saque"),
                    Column.real("nota_passe"),
                    Column.real("nota_ataque"),
                    Column.real("nota_bloqueio"),
                    Column.real("nota_defesa"),
                    Column.real("nota_atitude"),
                    Column.real("nota_media"),
                    Column.text("genero"),
                    Column.integer("ativo"),
                    Column.text("profile_id"),
        ...
        Table(
            ...
            columns =
                listOf(
                    ...
                    Column.real("nota_atitude"),
                    Column.real("media"),
                    Column.text("registrado_em"),
                ),
            indexes =
                porGrupo(Index("por_linha", IndexedColumn.ascending("player_id"))),
        ),
        Table(
            name = "dicas",
            columns =
